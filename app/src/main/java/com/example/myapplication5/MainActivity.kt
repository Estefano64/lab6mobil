...
fun UserProfileScreen() {
    Column(
        ...
        Text(text = "Nombre: Ulises Soto", style = MaterialTheme.typography.bodyMedium)
        Text(text = "Correo: ulises.soto@tecsup.com.com", style = MaterialTheme.typography.bodyMedium)
    }
}
